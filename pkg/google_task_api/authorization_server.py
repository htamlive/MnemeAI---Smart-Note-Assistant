...
class App:
    def __init__(self):
        ...
        def oauth2callback():
            ...
            flow.redirect_uri = config.GOOGLE_OAUTH2_CALLBACK_URL
            ...
            authorization = Authz.objects.filter(
                current_state=state, service_type=ServiceType.GOOGLE_TASK_API.value
            )
            if authorization:
            ...
            return flask.Response(
                "Credentials have been stored.", mimetype="text/plain"
            )
